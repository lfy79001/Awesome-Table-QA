...
4. **HybridQA: A Dataset of Multi-Hop Question Answering over Tabular and Textual Data** `HybridQA`
...
5. **TAT-QA: A Question Answering Benchmark on a Hybrid of Tabular and Textual Content in Finance** `TAT-QA`
...
6. **MultiModalQA: complex question answering over text, tables and images** `MultimodalQA`
