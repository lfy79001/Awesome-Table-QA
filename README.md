...
6. **Open Question Answering over Tables and Text** `OTT-QA` <ins>ICLR</ins> 2021
...
7. **MultiModalQA: complex question answering over text, tables and images** `MultimodalQA` <ins>ICLR</ins> 2021
...
8. **Finqa: A dataset of numerical reasoning over financial data** `FinQA` <ins>EMNLP</ins> 2021
